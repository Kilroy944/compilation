		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIfAccess().getExprsAssignment_1(), "rule__If__ExprsAssignment_1");
					put(grammarAccess.getIfAccess().getCmds1Assignment_3(), "rule__If__Cmds1Assignment_3");
					put(grammarAccess.getIfAccess().getCmds2Assignment_4_1(), "rule__If__Cmds2Assignment_4_1");
					...
					put(grammarAccess.getForAccess().getExprsAssignment_1(), "rule__For__ExprsAssignment_1");
					put(grammarAccess.getForAccess().getCmdsAssignment_3(), "rule__For__CmdsAssignment_3");
					put(grammarAccess.getWhileAccess().getExprsAssignment_1(), "rule__While__ExprsAssignment_1");
					...
					put(grammarAccess.getVarsAccess().getVarAssignment_0(), "rule__Vars__VarAssignment_0");
