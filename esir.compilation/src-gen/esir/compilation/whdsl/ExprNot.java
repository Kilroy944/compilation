 ...
 * </p>
 * <ul>
 *   <li>{@link esir.compilation.whdsl.ExprNot#getArg1 <em>Arg1</em>}</li>
 * </ul>
 *
 * @see esir.compilation.whdsl.WhdslPackage#getExprNot()
 * @model
 * @generated
 */
public interface ExprNot extends EObject
{
   ...
   * @see #setArg1(ExprEq)
   * @see esir.compilation.whdsl.WhdslPackage#getExprNot_Arg1()
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whdsl.ExprNot#getArg1 <em>Arg1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
