 ...
 * </p>
 * <ul>
 *   <li>{@link esir.compilation.whdsl.ExprOr#getArg1 <em>Arg1</em>}</li>
 *   <li>{@link esir.compilation.whdsl.ExprOr#getArg2 <em>Arg2</em>}</li>
 * </ul>
 *
 * @see esir.compilation.whdsl.WhdslPackage#getExprOr()
 * @model
 * @generated
 */
public interface ExprOr extends EObject
{
   ...
   * @see esir.compilation.whdsl.WhdslPackage#getExprOr_Arg1()
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whdsl.ExprOr#getArg1 <em>Arg1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setArg2(Expr)
   * @see esir.compilation.whdsl.WhdslPackage#getExprOr_Arg2()
   * @model containment="true"
   * @generated
   */
  Expr getArg2();
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whdsl.ExprOr#getArg2 <em>Arg2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
