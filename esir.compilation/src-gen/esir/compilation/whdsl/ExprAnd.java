 ...
 * </p>
 * <ul>
 *   <li>{@link esir.compilation.whdsl.ExprAnd#getArg1 <em>Arg1</em>}</li>
 *   <li>{@link esir.compilation.whdsl.ExprAnd#getArg2 <em>Arg2</em>}</li>
 * </ul>
 *
 * @see esir.compilation.whdsl.WhdslPackage#getExprAnd()
 * @model
 * @generated
 */
public interface ExprAnd extends EObject
{
   ...
   * @see esir.compilation.whdsl.WhdslPackage#getExprAnd_Arg1()
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whdsl.ExprAnd#getArg1 <em>Arg1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setArg2(Expr)
   * @see esir.compilation.whdsl.WhdslPackage#getExprAnd_Arg2()
   * @model containment="true"
   * @generated
   */
  Expr getArg2();
  ...
  /**
   * Sets the value of the '{@link esir.compilation.whdsl.ExprAnd#getArg2 <em>Arg2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
