 ...
 *   <li>{@link esir.compilation.whdsl.impl.CommandImpl#getExprs <em>Exprs</em>}</li>
 *   <li>{@link esir.compilation.whdsl.impl.CommandImpl#getCmdWhile <em>Cmd While</em>}</li>
 *   <li>{@link esir.compilation.whdsl.impl.CommandImpl#getCmdIf <em>Cmd If</em>}</li>
 *   <li>{@link esir.compilation.whdsl.impl.CommandImpl#getCmdForEach <em>Cmd For Each</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommandImpl extends MinimalEObjectImpl.Container implements Command
{
  ...
  public NotificationChain basicSetExprs(Exprs newExprs, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__EXPRS, oldExprs, newExprs);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExprs(Exprs newExprs)
  {
    if (newExprs != exprs)
    {
      NotificationChain msgs = null;
      if (exprs != null)
        msgs = ((InternalEObject)exprs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__EXPRS, null, msgs);
      if (newExprs != null)
        msgs = ((InternalEObject)newExprs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__EXPRS, null, msgs);
      msgs = basicSetExprs(newExprs, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__EXPRS, newExprs, newExprs));
  }
  ...
  public NotificationChain basicSetCmdWhile(CommandWhile newCmdWhile, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__CMD_WHILE, oldCmdWhile, newCmdWhile);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCmdWhile(CommandWhile newCmdWhile)
  {
    if (newCmdWhile != cmdWhile)
    {
      NotificationChain msgs = null;
      if (cmdWhile != null)
        msgs = ((InternalEObject)cmdWhile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__CMD_WHILE, null, msgs);
      if (newCmdWhile != null)
        msgs = ((InternalEObject)newCmdWhile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__CMD_WHILE, null, msgs);
      msgs = basicSetCmdWhile(newCmdWhile, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__CMD_WHILE, newCmdWhile, newCmdWhile));
  }
  ...
  public NotificationChain basicSetCmdIf(CommandIf newCmdIf, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__CMD_IF, oldCmdIf, newCmdIf);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCmdIf(CommandIf newCmdIf)
  {
    if (newCmdIf != cmdIf)
    {
      NotificationChain msgs = null;
      if (cmdIf != null)
        msgs = ((InternalEObject)cmdIf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__CMD_IF, null, msgs);
      if (newCmdIf != null)
        msgs = ((InternalEObject)newCmdIf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__CMD_IF, null, msgs);
      msgs = basicSetCmdIf(newCmdIf, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__CMD_IF, newCmdIf, newCmdIf));
  }
  ...
  public NotificationChain basicSetCmdForEach(CommandForEach newCmdForEach, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__CMD_FOR_EACH, oldCmdForEach, newCmdForEach);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCmdForEach(CommandForEach newCmdForEach)
  {
    if (newCmdForEach != cmdForEach)
    {
      NotificationChain msgs = null;
      if (cmdForEach != null)
        msgs = ((InternalEObject)cmdForEach).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__CMD_FOR_EACH, null, msgs);
      if (newCmdForEach != null)
        msgs = ((InternalEObject)newCmdForEach).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WhdslPackage.COMMAND__CMD_FOR_EACH, null, msgs);
      msgs = basicSetCmdForEach(newCmdForEach, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WhdslPackage.COMMAND__CMD_FOR_EACH, newCmdForEach, newCmdForEach));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case WhdslPackage.COMMAND__EXPRS:
        return basicSetExprs(null, msgs);
      case WhdslPackage.COMMAND__CMD_WHILE:
        return basicSetCmdWhile(null, msgs);
      case WhdslPackage.COMMAND__CMD_IF:
        return basicSetCmdIf(null, msgs);
      case WhdslPackage.COMMAND__CMD_FOR_EACH:
