...
public class WhdslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CommandWhileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "esir.compilation.Whdsl.CommandWhile");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CommandIfElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "esir.compilation.Whdsl.CommandIf");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CommandForEachElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "esir.compilation.Whdsl.CommandForEach");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExprSimpleElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cExprHeadAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final Keyword cExprHeadHdKeyword_1_1_0 = (Keyword)cExprHeadAssignment_1_1.eContents().get(0);
		private final Assignment cExprHeadAttAssignment_1_2 = (Assignment)cGroup_1.eContents().get(2);
		private final RuleCall cExprHeadAttExprParserRuleCall_1_2_0 = (RuleCall)cExprHeadAttAssignment_1_2.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_1_3 = (Keyword)cGroup_1.eContents().get(3);
		private final Group cGroup_2 = (Group)cAlternatives.eContents().get(2);
		private final Keyword cLeftParenthesisKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cExprTailAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final Keyword cExprTailTlKeyword_2_1_0 = (Keyword)cExprTailAssignment_2_1.eContents().get(0);
		private final Assignment cExprTailAttAssignment_2_2 = (Assignment)cGroup_2.eContents().get(2);
		private final RuleCall cExprTailAttExprParserRuleCall_2_2_0 = (RuleCall)cExprTailAttAssignment_2_2.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_2_3 = (Keyword)cGroup_2.eContents().get(3);
		private final Group cGroup_3 = (Group)cAlternatives.eContents().get(3);
		private final Keyword cLeftParenthesisKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Assignment cNomSymbAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cNomSymbSYMBOLTerminalRuleCall_3_1_0 = (RuleCall)cNomSymbAssignment_3_1.eContents().get(0);
		private final Assignment cSymbAttAssignment_3_2 = (Assignment)cGroup_3.eContents().get(2);
		private final RuleCall cSymbAttExprParserRuleCall_3_2_0 = (RuleCall)cSymbAttAssignment_3_2.eContents().get(0);
		...
		//(nil='nil' | vari=VARIABLE | symb=SYMBOL) | '(' exprHead='hd' exprHeadAtt=Expr ')' | '(' exprTail='tl' exprTailAtt=Expr
		//')' | '(' nomSymb=SYMBOL symbAtt+=Expr+ ')'
		public Alternatives getAlternatives() { return cAlternatives; }
		...
		//exprHead='hd'
		public Assignment getExprHeadAssignment_1_1() { return cExprHeadAssignment_1_1; }
		
		//'hd'
		public Keyword getExprHeadHdKeyword_1_1_0() { return cExprHeadHdKeyword_1_1_0; }
		
		//exprHeadAtt=Expr
		public Assignment getExprHeadAttAssignment_1_2() { return cExprHeadAttAssignment_1_2; }
		
		//Expr
		public RuleCall getExprHeadAttExprParserRuleCall_1_2_0() { return cExprHeadAttExprParserRuleCall_1_2_0; }
		...
		//exprTail='tl'
		public Assignment getExprTailAssignment_2_1() { return cExprTailAssignment_2_1; }
		
		//'tl'
		public Keyword getExprTailTlKeyword_2_1_0() { return cExprTailTlKeyword_2_1_0; }
		
		//exprTailAtt=Expr
		public Assignment getExprTailAttAssignment_2_2() { return cExprTailAttAssignment_2_2; }
		
		//Expr
		public RuleCall getExprTailAttExprParserRuleCall_2_2_0() { return cExprTailAttExprParserRuleCall_2_2_0; }
		...
		//nomSymb=SYMBOL
		public Assignment getNomSymbAssignment_3_1() { return cNomSymbAssignment_3_1; }
		
		//SYMBOL
		public RuleCall getNomSymbSYMBOLTerminalRuleCall_3_1_0() { return cNomSymbSYMBOLTerminalRuleCall_3_1_0; }
		
		//symbAtt+=Expr+
		public Assignment getSymbAttAssignment_3_2() { return cSymbAttAssignment_3_2; }
		
		//Expr
		public RuleCall getSymbAttExprParserRuleCall_3_2_0() { return cSymbAttExprParserRuleCall_3_2_0; }
	...
	public WhdslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tSYMBOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "esir.compilation.Whdsl.SYMBOL");
		this.tLC = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "esir.compilation.Whdsl.LC");
	}
